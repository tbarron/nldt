...
@pytest.mark.parametrize("start, end, exp", [
    ...
    # -------------------
    pytest.param(moment("2013-01-01"), 1357005600,
...
@pytest.mark.parametrize("y, w, d, h, m, s, x", [
    pytest.param(0, 0, 0, 0, 0, 0, duration(seconds=0), id='001'),
    pytest.param(0, 0, 0, 0, 0, 6, duration(seconds=6), id='002'),
    pytest.param(0, 0, 0, 0, 5, 0, duration(seconds=300), id='003'),
    pytest.param(0, 0, 0, 0, 5, 6, duration(seconds=306), id='004'),

    pytest.param(0, 0, 0, 4, 0, 0, duration(seconds=4*3600), id='005'),
    pytest.param(0, 0, 0, 4, 0, 6, duration(seconds=4*3600 + 6), id='006'),
    pytest.param(0, 0, 0, 4, 5, 0, duration(seconds=4*3600 + 300), id='007'),
    pytest.param(0, 0, 0, 4, 5, 6, duration(seconds=4*3600 + 306), id='008'),

    pytest.param(0, 0, 3, 0, 0, 0, duration(seconds=3*24*3600), id='009'),
    pytest.param(0, 0, 3, 0, 0, 6, duration(seconds=3*24*3600 + 6), id='010'),
    pytest.param(0, 0, 3, 0, 5, 0, duration(seconds=3*24*3600 + 300),
                 id='011'),
    pytest.param(0, 0, 3, 0, 5, 6, duration(seconds=3*24*3600 + 306),
                 id='012'),

    pytest.param(0, 0, 3, 4, 0, 0, duration(seconds=76*3600), id='013'),
    pytest.param(0, 0, 3, 4, 0, 6, duration(seconds=76*3600 + 6), id='014'),
    pytest.param(0, 0, 3, 4, 5, 0, duration(seconds=76*3600 + 300), id='015'),
    pytest.param(0, 0, 3, 4, 5, 6, duration(seconds=76*3600 + 306), id='016'),

    pytest.param(0, 2, 0, 0, 0, 0, duration(seconds=14*24*3600), id='017'),
    pytest.param(0, 2, 0, 0, 0, 6, duration(seconds=14*24*3600 + 6), id='018'),
    pytest.param(0, 2, 0, 0, 5, 0, duration(seconds=14*24*3600 + 300),
                 id='019'),
    pytest.param(0, 2, 0, 0, 5, 6, duration(seconds=14*24*3600 + 306),
                 id='020'),

    pytest.param(0, 2, 0, 4, 0, 0, duration(seconds=340*3600), id='021'),
    pytest.param(0, 2, 0, 4, 0, 6, duration(seconds=340*3600 + 6), id='022'),
    pytest.param(0, 2, 0, 4, 5, 0, duration(seconds=340*3600 + 300), id='023'),
    pytest.param(0, 2, 0, 4, 5, 6, duration(seconds=340*3600 + 306), id='024'),

    pytest.param(0, 2, 3, 0, 0, 0, duration(seconds=408*3600), id='025'),
    pytest.param(0, 2, 3, 0, 0, 6, duration(seconds=408*3600 + 6), id='026'),
    pytest.param(0, 2, 3, 0, 5, 0, duration(seconds=408*3600 + 300), id='027'),
    pytest.param(0, 2, 3, 0, 5, 6, duration(seconds=408*3600 + 306), id='028'),

    pytest.param(0, 2, 3, 4, 0, 0, duration(seconds=412*3600), id='029'),
    pytest.param(0, 2, 3, 4, 0, 6, duration(seconds=412*3600 + 6), id='030'),
    pytest.param(0, 2, 3, 4, 5, 0, duration(seconds=412*3600 + 300), id='031'),
    pytest.param(0, 2, 3, 4, 5, 6, duration(seconds=412*3600 + 306), id='032'),

    pytest.param(1, 0, 0, 0, 0, 0, duration(seconds=31536000), id='033'),
    pytest.param(1, 0, 0, 0, 0, 6, duration(seconds=31536000 + 6), id='034'),
    pytest.param(1, 0, 0, 0, 5, 0, duration(seconds=31536000 + 300), id='035'),
    pytest.param(1, 0, 0, 0, 5, 6, duration(seconds=31536000 + 306), id='036'),

    pytest.param(1, 0, 0, 4, 0, 0, duration(seconds=8764*3600), id='037'),
    pytest.param(1, 0, 0, 4, 0, 6, duration(seconds=8764*3600 + 6), id='038'),
    pytest.param(1, 0, 0, 4, 5, 0, duration(seconds=8764*3600 + 300),
                 id='039'),
    pytest.param(1, 0, 0, 4, 5, 6, duration(seconds=8764*3600 + 306),
                 id='040'),

    pytest.param(1, 0, 3, 0, 0, 0, duration(seconds=368*24*3600), id='041'),
    pytest.param(1, 0, 3, 0, 0, 6, duration(seconds=368*24*3600 + 6),
                 id='042'),
    pytest.param(1, 0, 3, 0, 5, 0, duration(seconds=368*24*3600 + 300),
                 id='043'),
    pytest.param(1, 0, 3, 0, 5, 6, duration(seconds=368*24*3600 + 306),
                 id='044'),

    pytest.param(1, 0, 3, 4, 0, 0, duration(seconds=8836*3600), id='045'),
    pytest.param(1, 0, 3, 4, 0, 6, duration(seconds=8836*3600 + 6), id='046'),
    pytest.param(1, 0, 3, 4, 5, 0, duration(seconds=8836*3600 + 300),
                 id='047'),
    pytest.param(1, 0, 3, 4, 5, 6, duration(seconds=8836*3600 + 306),
                 id='048'),

    pytest.param(1, 2, 0, 0, 0, 0, duration(seconds=379*24*3600), id='049'),
    pytest.param(1, 2, 0, 0, 0, 6, duration(seconds=379*24*3600 + 6),
                 id='050'),
    pytest.param(1, 2, 0, 0, 5, 0, duration(seconds=379*24*3600 + 300),
                 id='051'),
    pytest.param(1, 2, 0, 0, 5, 6, duration(seconds=379*24*3600 + 306),
                 id='052'),

    pytest.param(1, 2, 0, 4, 0, 0, duration(seconds=9100*3600), id='053'),
    pytest.param(1, 2, 0, 4, 0, 6, duration(seconds=9100*3600 + 6), id='054'),
    pytest.param(1, 2, 0, 4, 5, 0, duration(seconds=9100*3600 + 300),
                 id='055'),
    pytest.param(1, 2, 0, 4, 5, 6, duration(seconds=9100*3600 + 306),
                 id='056'),

    pytest.param(1, 2, 3, 0, 0, 0, duration(seconds=9168*3600), id='057'),
    pytest.param(1, 2, 3, None, None, None, duration(seconds=9168*3600),
                 id='058'),
    pytest.param(1, 2, 3, 0, 0, 6, duration(seconds=9168*3600 + 6), id='059'),
    pytest.param(1, 2, 3, 0, 5, 0, duration(seconds=9168*3600 + 300),
                 id='060'),
    pytest.param(1, 2, 3, 0, 5, 6, duration(seconds=9168*3600 + 306),
                 id='061'),

    pytest.param(1, 2, 3, 4, 0, 0, duration(seconds=9172*3600), id='062'),
    pytest.param(1, 2, 3, 4, 0, 6, duration(seconds=9172*3600 + 6), id='063'),
    pytest.param(1, 2, 3, 4, 5, 0, duration(seconds=9172*3600 + 300),
                 id='064'),
    pytest.param(1, 2, 3, 4, 5, 6, duration(seconds=9172*3600 + 306),
                 id='065'),
    ])
